...
EXECUTE VIEW_GIAOVIENGD('6A1','2021-2022');
...
EXECUTE CAPNHATDIEM('2858','TIN HOC','HK1','2021-2022',8.8,10,8.5,8);
EXECUTE CAPNHATDIEM('2858','NGU VAN','HK1','2021-2022',8.8,10,8.5,8);
EXECUTE CAPNHATDIEM('2858','AM NHAC','HK1','2021-2022',11,10,8.5,8);
EXECUTE CAPNHATDIEM('2858','NGU VAN','HK1','2021-2022',8.8,11,8.5,8);